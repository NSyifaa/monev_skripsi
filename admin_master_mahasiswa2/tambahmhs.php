              ...
              <form action="proses.php" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" maxlength="20" id="nim" name="nim" onkeypress="return Isnumeric(event);" placeholder="input nim" autofocus required>
                  </div>
                  <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" maxlength="50" id="prodi" name="prodi" placeholder="input Prodi" required>
                </div>
                 <div class="form-group">
                   ...
                   <select name="status" class="form-control"> 
                    ...
                    <option value="5"> Pased Out </option>
                   </select>
                </div>
                <div class="form-group">
                    <label for="angkatan">Angkatan</label>
                    <input type="text" class="form-control" maxlength="50" id="angkatan" name="angkatan" placeholder="input Angkatan" required>
                </div>
                <div class="form-group">
                    <label for="kontak">Kontak</label>
                    <input type="text" class="form-control" maxlength="50" id="kontak" name="kontak" placeholder="input kontak" required>
                </div>
                <div class="form-group">
