<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php if($konstruktor=='admin_master_mahasiswa'){echo 'menu-open';} if($konstruktor=='admin_master_angkatan'){echo 'menu-open';} if($konstruktor=='admin_master_prodi'){echo 'menu-open';} if($konstruktor=='admin_master_dosen'){echo 'menu-open';} if($konstruktor=='admin_master_periode'){echo 'menu-open';}?> ">
            <a href="#" class="nav-link <?php if($konstruktor=='admin_master_mahasiswa'){echo 'active';} if($konstruktor=='admin_master_angkatan'){echo 'active';} if($konstruktor=='admin_master_prodi'){echo 'active';} if($konstruktor=='admin_master_dosen'){echo 'active';} if($konstruktor=='admin_master_periode'){echo 'active';} if($konstruktor=='admin_kelasbimbingan'){echo 'active';}?>?> ">
          ...
          <li class="nav-item">
                <a href="../admin_kelasbimbingan" class="nav-link <?php if($konstruktor=='admin_kelasbimbingan'){echo 'active';}?>">
