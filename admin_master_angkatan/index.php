          ...
          <div class="col-lg-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="nav-icon fas fa-user-graduate"></i> Data Angkatan</h3>
              </div>
                <div class="card-body">

                  <a href="tambahangkatan.php" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-download"></i>Tambah Data</a>

                  <a href="proses.php?reset=reset_data&kd_angkatan=1" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin akan mereset semua data?')"><i class="nav-icon fas fa-sync"></i> Reset Data</a>

                  <button class="btn btn-sm btn-success" onclick="exportTableToExcel()"><i class="nav-icon fas fa-download"></i> Export ke Excel</button>
                  ...
                  <?php
                    ...
                    $queryangkatan = mysqli_query($con, "SELECT * FROM tbl_angkatan") or die (mysqli_error($con));
                    ...
                    while($dt_angkatan=mysqli_fetch_array($queryangkatan)){
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                          <a href="proses.php?kd_angkatan=<?=$dt_angkatan['kode_angkatan'];?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda akan menghapus data angkatan dengan kode [<?=$dt_angkatan['kode_angkatan'];?>] - Angkatan : [<?=$dt_angkatan['keterangan'];?>]')"><i class="nav-icon fas fa-trash"></i></a>
                        </center>
                        </td>
                      </tr>
                        <?php
