          ...
          <div class="col-lg-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><i class="nav-icon fas fa-plus"></i> Tambah Prodi</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="proses.php" method="post">
                <div class="card-body">
                  <a href="../admin_master_prodi" class="btn btn-primary btn-sm"><i class="nav-icon fas fa-chevron-left"></i>Kembali</a>
                  <br>
                  <div class="form-group">
                    <label for="kodeprodi">Kode Prodi</label>
                    <input type="text" class="form-control" maxlength="3" id="kodeprodi" name="kodeprodi" onkeypress="return Isnumeric(event);" required>
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="tambah" class="btn btn-primary btn-block"><i class="nav-icon fas fa-download"></i> Tambah Prodi</button>
                </div>
              </form>
            </div>
